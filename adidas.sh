...
cd $DIR/src/web/
CLASSPATH='/home/inigo/Documentos/AS/apache-tomcat-7.0.68/lib/servlet-api.jar:/home/inigo/Documentos/AS/json-lib.jar:/home/inigo/Documentos/AS/mysql-connector-java-5.1.38-bin.jar' javac servlets/*.java database/conection/*.java database/dataAccessObject/*.java database/valueObject/*.java 
